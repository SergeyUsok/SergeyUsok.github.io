...
export class RoutesManager {
    ...
    public process(route: Route): SVGElement {
        ...
        for (let connInfo of route.getConnectionsInfo()) {
            ...
            for (let i = 0; i < colorGroupes.length; i++) {
                ...
                let svgPath = SVG.straightConnection(segment.from, segment.to);//this.createSvgConnetion(segment, connInfo.data, connInfo.prev, connInfo.next);
